const totalesMonedas=document.getElementById('total_monedas');
const totalesBilletes=document.getElementById('total_billetes');
const totalTotal=document.getElementById('total_total');
...
// Seleccionar el input y el campo específico de la tabla
        ...
        cantidadMonedas50.addEventListener('input', function() {
            ...
            const precioOriginal = parseInt(montoMonedas50.textContent);
    ...
    //Billetes 2000
        ...
        const cantidadBilletes2000 = document.getElementById('cantidad_2000');    
        ...
        cantidadBilletes2000.addEventListener('input', function() {
            // Obtener el valor del input como número
            const cantidad_2000 = parseInt(cantidadBilletes2000.value);
            // Obtener el precio original como número
            ...
            // Actualizar el contenido del campo específico con el nuevo precio formateado
            totalBilletes2000.value = nuevoPrecio; 
            CalcularTotal();
            //campoTotalMonedas.value = parseInt(campoTotalMonedas.value) + totalMonedas50.innerHTML;
        });
    ...
    cantidadBilletes5000.addEventListener('input', function() {
        ...
        // Actualizar el contenido del campo específico con el nuevo precio formateado
        totalBilletes5000.value = nuevoPrecio; 
        CalcularTotal();
        //campoTotalMonedas.value = parseInt(campoTotalMonedas.value) + totalMonedas50.innerHTML;
    });
    ...
    cantidadBilletes10000.addEventListener('input', function() {
        ...
        // Actualizar el contenido del campo específico con el nuevo precio formateado
        totalBilletes10000.value = nuevoPrecio; 
        CalcularTotal();
        //campoTotalMonedas.value = parseInt(campoTotalMonedas.value) + totalMonedas50.innerHTML;
    });
    ...
    cantidadBilletes20000.addEventListener('input', function() {
        ...
        // Actualizar el contenido del campo específico con el nuevo precio formateado
        totalBilletes20000.value = nuevoPrecio; 
        CalcularTotal();
        //campoTotalMonedas.value = parseInt(campoTotalMonedas.value) + totalMonedas50.innerHTML;
    });
    ...
    cantidadBilletes50000.addEventListener('input', function() {
        ...
        // Actualizar el contenido del campo específico con el nuevo precio formateado
        totalBilletes50000.value = nuevoPrecio; 
        CalcularTotal();
        //campoTotalMonedas.value = parseInt(campoTotalMonedas.value) + totalMonedas50.innerHTML;
    });
        ...
        cantidadBilletes100000.addEventListener('input', function() {
            ...
            // Actualizar el contenido del campo específico con el nuevo precio formateado
            totalBilletes100000.value = nuevoPrecio; 
            CalcularTotal();
            //campoTotalMonedas.value = parseInt(campoTotalMonedas.value) + totalMonedas50.innerHTML;
        });
...
function CalcularTotal(){
    let monedas50=parseInt(totalMonedas50.value);
    let monedas100=parseInt(totalMonedas100.value);
    let monedas200=parseInt(totalMonedas200.value);
    let monedas500=parseInt(totalMonedas500.value);
    let monedas1000=parseInt(totalMonedas1000.value);
    parseInt(totalesMonedas.textContent=monedas50+monedas100+monedas200+monedas500+monedas1000);
    console.log("TOTAL MONEDAS: "+(totalesMonedas.innerHTML));

    let billetes2000=parseInt(totalBilletes2000.value);
    let billetes5000=parseInt(totalBilletes5000.value);
    let billetes10000=parseInt(totalBilletes10000.value);
    let billetes20000=parseInt(totalBilletes20000.value);
    let billetes50000=parseInt(totalBilletes50000.value);
    let billetes100000=parseInt(totalBilletes100000.value);
    parseInt(totalesBilletes.textContent=billetes2000+billetes5000+billetes10000+billetes20000+billetes50000+billetes100000);
    console.log("TOTAL BILLETES: "+(totalesBilletes.innerHTML));

    parseInt(totalTotal.textContent=parseInt(totalesMonedas.innerHTML)+parseInt(totalesBilletes.innerHTML));
    console.log("TOTAL TOTAL: "+(totalTotal.innerHTML));
