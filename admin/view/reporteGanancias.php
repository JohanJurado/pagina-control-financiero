    ...
    <section class="header">
        ...
        <div class="fecha">
            ...
            <div class="d-flex gap-5 align-items-center">
                ...
                <?php if($formato!="pdf"){?>
                    <a href="fechaReporte.php?reporte=ganancias&tipo=<?php echo $_GET['tipo'] ?>" class="btn btn-secondary me-5">Regresar</a>
                <?php }?>
            </div>
        </div>
    </section>
                ...
                <form action="reporteGanancias.php?tipo=<? echo $_GET['tipo'] ?>" class="filtro d-flex flex-column w-100 gap-3" method="post" enctype="multipart/form-data">
                    ...
                    <div class="d-flex gap-4 align-items-end w-75">
                        ...
                        <div class="w-75">
                            ...
                            <input type="text" id="total" class="form-control h-auto fw-600" value="$<?php echo number_format($reportes[0]['gananciaTotal']+0) ?>" readonly>
                        </div>
                    </div>
                </form>
            </div>
