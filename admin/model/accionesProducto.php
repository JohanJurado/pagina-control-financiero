...
//AQUI EMPIEZA LA FUNCION REGISTRAR /*
       ...
       // $uploadFile = $carpeta . basename($nombreArchivo);
        ...
        $sqlReg="INSERT INTO producto(`id_prod`, `nombre_prod`, `descripcion_prod`, `costo_prod`, `gananciainicial_prod`, `valorganancia_prod`, `stock_prod`, `stockMin_prod`, `importancia_prod`, `id_catProd`, `id_provProd`, `imagen`) VALUES (NULL,?,?,?,?,?,?,?,?,?,?,?)";
        ...
        $reg->bindParam(5,$valorganancia_prod);
        $reg->bindParam(6,$stock_prod);
        $reg->bindParam(7,$stockMin_prod);
        $reg->bindParam(8,$importancia_prod);
        $reg->bindParam(9,$id_catProd);
        $reg->bindParam(10,$id_provProd);
        $reg->bindParam(11,$imagen);
        ...
        if (isset($data['imagen'])){
            ...
            $sqlReg = "UPDATE producto SET nombre_prod = ?,descripcion_prod = ?, costo_prod = ?,gananciainicial_prod = ?, valorganancia_prod = ?, stock_prod = ?, stockMin_prod = ?, importancia_prod = ?, id_catProd = ?, id_provProd = ?, imagen = ? WHERE id_prod = $id_prod";
            ...
            $sqlReg = "UPDATE producto SET nombre_prod = ?,descripcion_prod = ?, costo_prod = ?,gananciainicial_prod = ?, valorganancia_prod = ?, stock_prod=?, stockMin_prod = ?, importancia_prod=?, id_catProd=?, id_provProd=? WHERE id_prod = $id_prod";
